...
A simple dashboard using only HTML and Javascript, that gathers remote data via API calls out to three other websites for weather, 
train times and our todo list and displays the results on a monitor in our kitchen.
...
| minimumWalkTransitTime    | The minimum period of time that you can comfortably walk to the station.                                                                                                                                                                         |                                                  hours, minutes, seconds relative to <br/> departure time of the train |
| minimumRunTransitTime     | The minimum period of time that you can run to the station                                                                                                                                                                                       |                                                  hours, minutes, seconds relative to <br/> departure time of the train |
| minimumDriveTransitTime   | The minimum period of time that you can drive to the station                                                                                                                                                                                     | hours, minutes, seconds relative to <br/> departure time of the train (optional field - sometimes you cant/wont drive) |
